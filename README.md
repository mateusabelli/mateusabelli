<div align="center">
  <picture>
    <source
      srcset="assets/ambigram-light.png"
      media="(prefers-color-scheme: dark)"
    />
    <source
      srcset="assets/ambigram-dark.png"
      media="(prefers-color-scheme: light), (prefers-color-scheme: no-preference)"
    />
    <img width="400" height="40" src="assets/ambigram-dark.png" />
  </picture>
...
[![Ko-Fi](https://img.shields.io/badge/Ko--fi-F16061?&logo=ko-fi&logoColor=white)](https://ko-fi.com/mateusabelli)
[![GitHub User's stars](https://img.shields.io/github/stars/mateusabelli?style=social&color=yellow)](https://github.com/mateusabelli?tab=repositories&q=&type=&sort=stargazers)

</div>

## 👩‍💻 About Me

I'm Mateus, a developer and open source enthusiast from Brazil 🇧🇷.

I enjoy exploring creative ways to develop projects and to have fun while learning new things in the process. I also like to work on ideas and build them into complete solutions.

To craft high quality software, I believe that it should to be meaningful, helpful, teach something along the way, and/or just be fun to do it. Otherwise, I'd just be a machine, much inferior to the other ones out there.

## 🛠️ Current Stack

- **Languages:** C#, TypeScript.
- **Frameworks:** ASP.NET, React, Avalonia.

## 🚀 Interests

- **Software Engineering**: Building and maintaining enterprise systems and applications.
- **Game Dev**: Playing around with the Godot Engine to make cool games.
- **Open Source**: Contributing to [Flamenco](https://flamenco.blender.org/), the free and open source self-hosted render farm.
...
<a href="https://dev.to/mateusabelli/prompteer-ai-prompts-engaging-comments-3h7o">
  <img width="64px" height="64px" src="assets/refine-dev-hackathon.webp" />
</a>
<a href="https://dev.to/mateusabelli/introducing-pull-request-tracker-a-github-action-3ijh">
  <img width="64px" height="64px" src="assets/github-dev-hackathon.webp" />
</a>
<a href="https://dev.to/mateusabelli/omedev-talk-to-developers-mongodb-atlas-hackathon-2022-on-dev-3n9k">
  <img width="60px" height="64px" src="assets/mongo-dev-hackathon.webp" />
</a>
<a href="https://hacktoberfest.com/">
  <img width="64px" height="64px" src="assets/hacktoberfest-2022-badge.webp" />
</a>
